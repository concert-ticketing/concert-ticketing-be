...
public class InquiryController {
    ...
    public ResponseEntity<InquiryResponseDto> getInquiryDetail(@PathVariable Long id) {
        ...
        try {
            InquiryResponseDto inquiry = inquiryService.getInquiryByIdAndUser(id, userId);
    ...
    public ResponseEntity<InquiryResponseDto> createInquiry(
        ...
        InquiryRequestDto requestDto = objectMapper.readValue(inquiryJson, InquiryRequestDto.class);
